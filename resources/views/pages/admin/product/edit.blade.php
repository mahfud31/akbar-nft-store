                  ...
                  <div class="row">
                    ...
                    {{-- <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="file" name="photos" value="{{ $item->photos }}" class="form-control">
                      </div>
                    </div> --}}
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>product links</label>
                        <input type="url" name="link_redirect" value="{{ $item->link_redirect }}" class="form-control" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
